...
public class MirrorPatternTopicMixed {
    @Getter
    private final String inputPattern = ".*-input1";
    @Getter
    private final String inputTopic = "input2";

    @Getter
    private final String outputTopic = "output";

    public static void main(final String[] args) {
        final MirrorPatternTopicMixed wordCount = new MirrorPatternTopicMixed();
    ...
    public Topology getTopology() {
        ...
        final KStream<String, String> input1 = builder.stream(Pattern.compile(this.inputPattern));
        final KStream<String, String> input2 = builder.stream(this.inputTopic);
